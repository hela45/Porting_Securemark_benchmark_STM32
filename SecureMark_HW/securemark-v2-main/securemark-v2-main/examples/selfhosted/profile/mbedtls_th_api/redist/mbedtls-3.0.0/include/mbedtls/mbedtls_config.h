...
/*
 * ptorelli:eembc
 * This is defined in common.h which is in the library, not the include area.
 * Unfortunately without defining this here, you cannot access the private members
 * of the ECDH structure and get to "grp", for example.
 */
